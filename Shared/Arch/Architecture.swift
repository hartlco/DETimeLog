...
typealias ReduceFunction<State, Action, Environment> = (inout State, Action, Environment) async -> Void

@dynamicMemberLookup
public final class ViewStore<State, Action, Environment>: ObservableObject {
